...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _src_scss_estilos_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../src/scss/estilos.scss */ \"./src/scss/estilos.scss\");\n/* harmony import */ var _src_scss_estilos_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_src_scss_estilos_scss__WEBPACK_IMPORTED_MODULE_0__);\n!(function webpackMissingModule() { var e = new Error(\"Cannot find module './modulos/js/search'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n__webpack_require__(/*! babel-polyfill */ \"./node_modules/babel-polyfill/lib/index.js\");\n/* css */\n\n\n // JS\n\n\n/** Estado Global de la aplicación\n    - objeto buscar\n    - objeto receta actual\n    - objeto lista de la compra\n    - objeto recetas con liks\n**/\n\nvar state = {};\n\nvar controlSearch =\n/*#__PURE__*/\nfunction () {\n  var _ref = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee() {\n    var query;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            // 1) Tomar la búsqueda de la vista\n            query = 'pizza';\n\n            if (!query) {\n              _context.next = 6;\n              break;\n            }\n\n            // 2) Nueva búsqueda y añadirla en el estado\n            state.search = new !(function webpackMissingModule() { var e = new Error(\"Cannot find module './modulos/js/search'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(query); // 3) Preparar la UI para los resultados\n            // 4) Buscar recetas\n\n            _context.next = 5;\n            return state.search.getResult();\n\n          case 5:\n            // la búsqueda es asíncrona\n            // 5) Renderizar los resultados \n            console.log(state.search.results);\n\n          case 6:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n\n  return function controlSearch() {\n    return _ref.apply(this, arguments);\n  };\n}();\n\ndocument.querySelector('.buscador').addEventListener('submit', function (e) {\n  e.preventDefault();\n  controlSearch();\n});\n\n//# sourceURL=webpack:///./src/index.js?");
...
eval("// extracted by mini-css-extract-plugin\n\n//# sourceURL=webpack:///./src/scss/estilos.scss?");
